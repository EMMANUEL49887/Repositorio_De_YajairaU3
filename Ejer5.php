...
class Caja {
     ...
     * @param Caja $otraCaja Objeto Caja a copiar.
     * @return Caja Nueva instancia de Caja con las mismas dimensiones.
     */
     ...
     * @return Caja Nueva instancia de Caja con dimensiones aumentadas en un 25%.
     */
     ...
     * @return Caja Nueva instancia de Caja con dimensiones reducidas en un 25%.
     */
